...
async function main() {
    ...
    const userRegistrationContractAddress = await userContract.getAddress();
    fs.writeFileSync("./user-registration-contract-address.json", userRegistrationContractAddress);
